...
export default function AddPayment() {
    ...
    <View style={styles.container}>
        <View style={styles.creditCardContainer}>
            <Card number={cardNumber} name={name} validity={validity} cvv={cvv}/>   
        </View>
        <View style={styles.formContainer}>
            <View style={styles.form}>
                ...
                <TextInput placeholder='Validade' style={styles.input} value={validity} onChangeText={setValidity}></TextInput>
